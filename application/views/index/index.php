...
<div class="carousel slide" id="carousel-generic" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="<?=base_url('resources/img/mobile.jpg')?>">
            <div class="carousel-caption carousel-intro">
                <div>Dabao's education</div>
                <div>some desc?</div>
    ...
    <a class="right carousel-control" href="<?=base_url('#carousel-generic')?>" role="button" data-slide="next">
	...
	<div class="container">
        ...
        <div class="row">
            <?php foreach ($courses as $course): ?>
                <div class="col-md-3">
                    <a class="recommend-courses-item" href="<?=site_url('course/'.$course->id)?>">
                        <img src="<?=base_url('resources/'.$course->img)?>" alt="<?=$course->name?>">
                        <div class="recommend-courses-content">
                            <div class="recommend-courses-name"><?=$course->name?></div>
                            <div class="recommend-courses-desc"><?=$course->desc?></div>
        ...
        <div class="home-section-footer recommend-courses-footer">
            <a href="<?=site_url('courses')?>">查看全部</a>
        </div>
	</div>
</div>
