...
<link href="/resources/js/fine-uploader/fine-uploader-new.css" rel="stylesheet">
...
<hr />
<form action="/cursor/<?php echo $cursor->id;?>/update" class="dropzone" id="my-awesome-dropzone" method="POST">
    <h3>基本信息</h3>
...
<script src="/resources/js/fine-uploader/jquery.fine-uploader.min.js"></script>
<!-- Fine Uploader Gallery template
    ...
    <script>
        $('#fine-uploader-gallery').fineUploader({
            ...
            request: {
                endpoint: '/cursor/<?php echo $cursor->id;?>/upload'
            },
            retry:{
                enableAuto: true,
            },
            ...
            thumbnails: {
                placeholders: {
                    waitingPath: '/resources/image/fine-uploader/placeholders/waiting-generic.png',
                    notAvailablePath: '/resources/image/fine-uploader/placeholders/not_available-generic.png'
                }
            },
            autoUpload: false,
            validation: {
