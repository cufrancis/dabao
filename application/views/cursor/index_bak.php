<div class="container">
    ...
    <div id="video_list">
        <?php foreach($videos as $video):?>
            <a class="video_click" id=<?=$video->id;?> vid="<?php echo $video->id;?>" url="<?=$video->url;?>"><?php echo $video->name;?></a><br />
        <?php endforeach;?>
...
$(document).ready(function(){
    $('.video_click').click(function(){
        ...
        video_div.empty();
        video_div.append('<video src="'+url+'" id="video_video" controls="controls">您的浏览器不支持 video 标签。</video>')
