            ...
            <div class="container-fluid am-cf">
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 教師後臺管理首頁 <small><?=$this->session->teacher['username']?></small></div>
                        <p class="page-header-description">The Management of Su Yuting 's Educational System</p>
                    </div>
                ...
                <div class="row am-cf">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-4 widget-margin-bottom-lg ">
                        <div class="tpl-user-card am-text-center widget-body-lg">
                            ...
                            <img class="achievement-image" src="<?=base_url('resources/admin/assets/img/user07.png')?>" alt="">
